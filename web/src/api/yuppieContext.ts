...
import { QueryOperation } from './yuppieComponents';

export type YuppieContext = {
  fetcherOptions: {
    /**
 ...
 */
export function useYuppieContext<
...
>(
  ...
  return {
    ...
    queryOptions: {
      enabled: access_token !== null && (queryOptions?.enabled ?? true),
    },
